...
export default function AdminMembers() {
  ...
  const updateMutation = useMutation({
    mutationFn: async ({ id, data }: { id: string; data: Partial<typeof formData> }) => {
      return apiRequest("PATCH", `/api/members/${id}`, {
        ...data,
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button data-testid="button-admin-add-member" onClick={handleAdd}>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="relative w-full sm:w-64">
              ...
              <Input
                ...
                className="pl-9"
                data-testid="input-admin-search-member"
              />
            </div>
          </div>
        </CardHeader>
            ...
            <div className="space-y-3">
              {filteredMembers?.map((member) => (
                <div
                  ...
                  data-testid={`admin-row-member-${member.id}`}
                >
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {member.status === "pending" && (
                      <div className="flex gap-1">
                        <Button 
                          ...
                          data-testid={`button-admin-approve-${member.id}`}
                        >
                        ...
                        <Button 
                          ...
                          disabled={updateMutation.isPending}
                          data-testid={`button-admin-reject-${member.id}`}
                        >
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="ghost" size="icon" data-testid={`button-admin-menu-member-${member.id}`}>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                data-testid="input-admin-member-email"
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                data-testid="input-admin-member-phone"
              />
            </div>
            <div className="grid gap-2">
              ...
              >
                <SelectTrigger data-testid="select-admin-member-agent">
            ...
            <div className="grid gap-2">
              ...
              >
                <SelectTrigger data-testid="select-admin-member-status">
          ...
          <DialogFooter>
            ...
            <Button 
              ...
              data-testid="button-admin-submit-add-member"
            >
          ...
          <div className="grid gap-4 py-4 max-h-[60vh] overflow-y-auto">
            <div className="grid gap-2">
              ...
              <Input
                ...
                value={formData.name}
                onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                data-testid="input-admin-edit-member-name"
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                value={formData.email}
                onChange={(e) => setFormData({ ...formData, email: e.target.value })}
                data-testid="input-admin-edit-member-email"
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                value={formData.phone}
                onChange={(e) => setFormData({ ...formData, phone: e.target.value })}
                data-testid="input-admin-edit-member-phone"
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                data-testid="input-admin-edit-member-balance"
              />
            </div>
            <div className="grid gap-2">
              ...
              <Select
                ...
                onValueChange={(val) => setFormData({ ...formData, assignedAgentId: val })}
              >
                <SelectTrigger data-testid="select-admin-edit-member-agent">
            ...
            <div className="grid gap-2">
              ...
              <Select
                ...
                onValueChange={(val) => setFormData({ ...formData, status: val })}
              >
                <SelectTrigger data-testid="select-admin-edit-member-status">
                  <SelectValue placeholder="Pilih status" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="pending">Pending</SelectItem>
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                data-testid="input-admin-edit-member-bank-name"
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                data-testid="input-admin-edit-member-bank-account"
              />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="edit-bank-name-holder">Nama Pemilik Rekening</Label>
              <Input
                id="edit-bank-name-holder"
                value={formData.bankAccountName}
                onChange={(e) => setFormData({ ...formData, bankAccountName: e.target.value })}
                placeholder="Nama sesuai rekening"
                data-testid="input-admin-edit-member-bank-holder"
              />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="edit-credit-score">Credit Score</Label>
              <Input
                id="edit-credit-score"
                type="number"
                value={formData.creditScore}
                onChange={(e) => setFormData({ ...formData, creditScore: Number(e.target.value) })}
                data-testid="input-admin-edit-member-credit-score"
              />
            </div>
          </div>
          <DialogFooter>
            ...
            <Button 
              onClick={submitEdit} 
              disabled={updateMutation.isPending}
              data-testid="button-admin-submit-edit-member"
            >
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Apakah Anda yakin ingin menghapus anggota "{selectedMember?.name}"?
          ...
          <DialogFooter>
            ...
            <Button 
              ...
              data-testid="button-admin-confirm-delete-member"
            >
      ...
      <Dialog open={withdrawalLockDialogOpen} onOpenChange={setWithdrawalLockDialogOpen}>
        <DialogContent>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              <Label htmlFor="admin-lock-reason">Alasan Penguncian</Label>
              <Input
                ...
                data-testid="input-admin-withdrawal-lock-reason"
              />
            </div>
          </div>
          <DialogFooter>
            ...
            <Button 
              ...
              disabled={updateMutation.isPending}
              data-testid="button-admin-confirm-lock-withdrawal"
            >
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                data-testid="input-admin-bank-account-number"
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                data-testid="input-admin-bank-account-name"
              />
            </div>
          </div>
          <DialogFooter>
            ...
            <Button 
              ...
              disabled={updateMutation.isPending}
              data-testid="button-admin-save-bank"
            >
